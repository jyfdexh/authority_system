		...
		<div class="layui-header">
			...
			<ul class="layui-nav layui-layout-right">
				<li class="layui-nav-item"><a href="javascript:;"> <img
						src="http://192.168.179.128:4545/${sessionScope.user.userImg}" class="layui-nav-img">${sessionScope.user.nickname}
<%--		    in Linux:    http://192.168.179.128:4545/${sessionScope.user.userImg}--%>
				</a>
				</li>
